...
<body>
    ...
    <div class="px-4 py-5 my-5">
        <div class="text-center">
            <h1 class="display-3 fw-bold">과거 일봉차트 수동매매 시뮬레이션</h1>
        ...
        <article class="blog-post">
            <div class="text-center">
                ...
                <h4 class="blog-post-meta">2022년 1월 23일 by 펭수르</h4>
            </div>
            ...
            <p>그래서 지금은 매일 종가매수를 통해 시드를 키워나가고, 나머지 금액으로 일반매매 훈련을 하고 있습니다.</p>
            <p>일반 매매를 하면서 과거의 차트를 켜놓고 상상으로 시뮬레이션을 해봤는데, 훈련 효과가 적더군요.</p>
            <p>자연스레 "매일매일 매수/매도/건너뛰기를 판단하면서 실적을 측정하면서 훈련해보고 싶다"라는 욕심이 생겼습니다.</p>
            <p>그래서 과거 일봉차트 매매 시뮬레이션을 만들었습니다.</p>
            <p></p>
            <p>이 메뉴얼은 매매 훈련을 위한 일봉매매 시뮬레이션 메뉴얼입니다.</p>
