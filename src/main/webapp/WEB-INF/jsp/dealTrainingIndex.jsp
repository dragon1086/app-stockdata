    ...
    <form action="deal-calculate" method="post" name="calculateRequestFrom">
        <div class="px-4 py-5 my-5 text-center">
            ...
            <div class="display-5 mx-auto">
                ...
                <p class="lead mb-4">하루하루 다음 일봉을 예상해보며, 매매와 기다림을 선택해가며 주어진 환경에서 실현수익을 만드는 것이 목표입니다.</p>
                <p></p>
                <p class="lead mb-4">"종목", "종목에 배분할 총금액", "시작 비중"을 입력하면, 랜덤하게 3년치의 일봉차트가 보여집니다.</p>
                <p class="lead mb-4">시작 시점, 평균 단가, 평가 손익은 랜덤으로 정해집니다.</p>
                <p class="lead mb-4">이때 평균 단가는 시작시점 종가의 -30% ~ 30%로 설정되며, 여러분이 과거 특정 시점부터 관리해온 평균단가라고 가정했습니다.</p>
                <p class="lead mb-4">만약 "시작 비중"을 0으로 입력하면, 처음부터 새로 시작할 수 있습니다.</p>
                <p></p>
